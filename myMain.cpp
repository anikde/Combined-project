...
int main(int argc, char** argv){
	...
	{
		double p[]={9,8,7,6,5,4,3,2,1};
		double q[]={1,2,3,4,5,6,7,8,9};
		mat::MatrixAddition(3,3,(double *)p,(double *)q, mat::StorageOrder::ROW_MAJOR);
	}
	{
		{
		double p[]={9,8,7,6,5,4,3,2,1};
		double q[]={1,2,3,4,5,6,7,8,9};
		mat::MatrixMultiplication(3,3,(double *)p,(double *)q, mat::StorageOrder::ROW_MAJOR);
	}
	}
